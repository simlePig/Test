...
//------QC-SOURCE-SPLIT------
                ...
                (function() {
                    var nodeEnv = typeof require !== 'undefined' && typeof process !== 'undefined';
                    var __module = nodeEnv ? module : {exports:{}};
                    var __filename = 'preview-scripts/assets/AnimationController.js';
                    var __require = nodeEnv ? function (request) {
                        return cc.require(request);
                    } : function (request) {
                        return __quick_compile_project__.require(request, __filename);
                    ...
                    function __define (exports, require, module) {
                        if (!nodeEnv) {__quick_compile_project__.registerModule(__filename, module);}"use strict";
cc._RF.push(module, '37b1fbN8LREw6ZRZNBCsA9Q', 'AnimationController');
...
var AnimationController = /** @class */ (function (_super) {
    ...
    AnimationController.prototype.onShowEnd = function () {
        this.node.getComponent(cc.Animation).play('button_standy');
    };
    AnimationController.prototype.onClickEnd = function () {
        this.node.getComponent(cc.Animation).play('button_standy');
    };
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
//------QC-SOURCE-SPLIT------
